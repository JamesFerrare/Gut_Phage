...
dist_dict_path = '%svotu_dist_dict.pickle' % config.data_directory
...
def make_votu_dist_dict(min_n_country_samples=min_n_country_samples):
    ...
    '''
    Calculates Jaccard distance between phage communities at different taxonomic scales.
    min_n_country_samples = Minimum # of samples for a country to be included in the analysis
    '''
