...
for l_idx, l in enumerate(data_utils.lifestyle_all_and_both):
    ...
    survival_array = stats_utils.make_survival_dist(checkv_completeness_l, completeness_range)
    ax.plot(completeness_range, survival_array, lw=2, ls='-', c=plot_utils.lifestyle_color_dict[l], label=l.capitalize())
